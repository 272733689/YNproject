...
class EnergyOverviewOperator  extends React.Component{
    ...
    getUserMap= () => {
        reqwest({
            ...
            let arry1=[];
            if(ds[0].result !== null){
                console.log('ds[0].result[i].valids是  ' ,ds[0].result);
                ...
                console.log('数据的数据是1  ' ,arry1);
                console.log('数据的数据是1  ' ,arry);
                console.log('数据的数据是1  ' ,arry2);
                console.log('数据的数据是1  ' ,ds[0].resultNum);
    ...
    getUserScale= () => {
        reqwest({
            ...
            var ds=eval('('+data+')');
            console.log('管控的值是' ,ds[0].maxValue.maxValue);
            console.log('管控的值222是' ,ds[0].profitEsMgmt);
            ...
            if(ds[0].maxValue === 0 ){
                ...
                this.setState({
                    maxValue : ds[0].maxValue.maxValue ,
                })
            ...
            if(ds[0].profitEsMgmt === 0 ){
                ...
                this.setState({
                    profitEsMgmt : ds[0].profitEsMgmt.profitEsMgmt,
                })
            }
            // this.setState({
    ...
    getEnergyDetails = () => {
        ...
        reqwest({
            ...
            if(ds[0].carbonResultDay !== null && ds[0].carbonResultDay !== undefined ){
                carbonResultDayValue =ds[0].carbonResultDay; //当天碳排放
            }else {
    ...
    getEcharts= () => {
        ...
        userScale.setOption({
            ...
            legend: {
                ...
                //     10, // 左
                // ]
                data:['综合','办公','商场','宾馆','学校','文化','体育','医院','通信',]
            },
            series: [
                {
                    name:'访问来源',
                    ...
                    center: ['35%', '40%'],  // 设置饼状图位置，第一个百分数调水平位置，第二个百分数调垂直位置
...
// 组件文档 https://elemefe.github.io/react-amap/components/about
    ...
    jumpPage=(marker)=>{
        ...
        console.log("orgNo的值是"+this.state.orgNo);
        window.location.href = '/console/energyOverviewOperator/jumpPage?id='+ extData.id +"&orgNo="+this.state.orgNo;
    }
        ...
        return (
            <div className="div-body" >
                <div className="div-page" >
                    <Col>
                        < Col  span={16}>
                            <Card style={{ height : 604 ,marginTop: 10}}  bodyStyle={{padding: "0"}} >
                                <Col span={7}>
                                <span   style={{marginLeft:10, marginTop: 11,lineHeight:'24px',float:'left'  ,fontSize:16,
                                }}>
                                    用户分布地图
                                </span>
                                </Col>
                                <Col  span={17}>
                                    <span className="position"  style={{lineHeight:'24px',float:'right', marginTop:8,marginRight:10}}>
                                            {/*<Search*/}
                                        {/*placeholder=" "*/}
                                ...
                                <Col span={24}>
                                    <div style={{width: '100%', height: 562, padding:10}}>
                                        <Map  center={this.state.mapCenter} zoom={8}>
                                            <Markers
                                                markers={this.state.markers}
                                                events={this.markerEvents}
                                                useCluster={true}  //是否启用聚合插件   //plugins={['ToolBar']}
                                                /*useCluster={this.state.useCluster} true*/
                                                // render={this.renderMarkerLayout(this.state.markers)} //设定坐标的外观
                                            ...
                                            <Markers
                                                ...
                                                /*useCluster={this.state.useCluster} true*/
                                                // render={this.renderMarkerLayout(this.state.markers)} //设定坐标的外观
                                                render={this.renderMarkerLayout2}
                                            />
                        ...
                        <Col span={8}>
                            <Col>
                                <Col>
                                    <div style={{ height: 230 ,marginLeft:10, marginTop: 10}}>
                                        <Card  >
                                            <Row span={24}>
                                                <Col span={14}>
                                                    <Row span={24}>
                                                    ...
                                                    <Row>
                                                        <div  id="userScaleS" style={{ width:"100%",height:220}} className="classUserScaleS"  >  </div>
                                                    </Row>
                                                </Col>
                                                <Col span={2}>
                                                </Col>
                                                <Col span={8}>
                                                    <Row>
                                                        <Row span={24}>
                                                            <Col  span={20} className="todayElectricityS" >
                                                                {this.state.maxValue}</Col>
                                                            {/*<Col span={4}>&nbsp;&nbsp;（kW）</Col>*/}
                                                        </Row>
                                                        <Col span={24}>
                                                            最高负荷（kW）
                                                    ...
                                                    <Row>
                                                        <Col span={24}>
                                                            <Col  span={20} className="todayElectricityS">{this.state.profitEsMgmt}</Col>
                                                            {/*<Col span={4}>&nbsp;&nbsp;（元）</Col>*/}
                                                        </Col>
                                                        <Col span={24}  >
                                                            管控收益（元）
                                                    ...
                                                    <Row>
                                                        <Col span={24}>
                                                            <Col span={20}  className="todayElectricityS">{this.state.userNum}</Col>
                                                            {/*<Col span={4}>&nbsp;&nbsp; （户）</Col>*/}
                                                        </Col>
                                                        <Col span={24}  >
                                                            用户总数（户）
                                            ...
                                            {/*                                            <Row>
                                             ...
                                             <p className="madalFont" style={{marginLeft:-6 }}>用户数量</p>
                                             </div>
                                             </Row>
                                             <Row>
                                             <Col span={15} >
                                             ...
                                             <Col span={9}>
                                             <Col style={{ marginLeft:35,marginTop: '-20%'}} >
                                             <Row>
                                             <Row span={24}>
                                             <div style={{float:'left',marginTop: '10%'}} className={this.state.fontSizeS}>{this.state.maxValue}</div>
                                             <div style={{marginTop: '20%'}}>（kW） </div>
                                             <p style={{float:'left',marginTop:11,}} >（kW）</p>
                                             </Row>
                                             ...
                                             <Col span={24}>
                                             <div style={{float:'left',}} className={this.state.fontSizeS}>{this.state.profitEsMgmt}</div>
                                             <div style={{marginTop: '8%'}} >（元）</div>
                                             </Col>
                                             <Col span={24} style={{marginTop: '-6%'}} >
                                             管控收益
                                             </Col>
                                             ...
                                             <Col span={24}>
                                             <div style={{float:'left',}} className={this.state.fontSizeS}>{this.state.userNum}</div>
                                             <div style={{marginTop: '8%'}} >（户）</div>
                                             </Col>
                                             <Col span={24} style={{marginTop: '-6%'}} >
                                             用户总数
                                             </Col>
                                ...
                                <Col>
                                    <Card style={{ height: 364 ,marginLeft:10 ,marginTop: 10}}>
                                        {/*<p className="fontCardNmae">用能概况</p>*/}
                                        <p className="madalFont" style={{marginLeft:-6,marginTop: -15 }}>用能概况</p>
                                        {/*<p className="fontCardNmae" style={{marginTop: -10,}}>用能概况</p>*/}
                                        <Col style={{ height: 100 ,marginLeft:10 }}>
                                            <Col span={24}>
                                                <Col span={10}>
                                                    今日用电
                                                </Col>
                                            ...
                                            <Col span={24}>
                                                <Col span={10}>
                                                    <p style={{float:'left',marginTop: -5,}} className={this.state.fontSizeS}>{this.state.resultDay}</p>
                                                    <p style={{float:'left',marginTop: 11.25,marginLeft:10}} > kWh</p>
                                                </Col>
                                                <Col span={10}>
                                                    <p style={{float:'left',marginTop: -5,}}  className={this.state.fontSizeS}>{this.state.carbonResultDay}</p>
                                                    <p style={{float:'left',marginTop:11,marginLeft:10}}> 吨</p>
                                                </Col>
                                                <Col span={4}>
                                                    <Col className="upButton"> <p style={{float:'left',marginTop:'5%',marginLeft:'25%'}} className="upButtonFont">{this.state.PercentageDay}</p></Col>
                                                </Col>
                                            </Col>
                                            <Col>
                                                <Col span={15} style={{float:'left',marginTop:-35,}}>
                                                    <p style={{float:'left',}}>昨日同期用电：</p>
                                                    <p style={{float:'left',marginLeft:5}} className="kWh" >{this.state.yesterday}</p>
                                                    <p style={{float:'left',marginLeft:11}}> kWh</p>
                                                    <p> </p>
                                                </Col>
                                                <Col span={10}>
                                                </Col>
                                        ...
                                        <Col style={{ height: 100 ,marginLeft:10 }}>
                                            ...
                                            <Col span={24}>
                                                <Col span={10}>
                                                    <p style={{float:'left',marginTop: -5,}} className={this.state.fontSizeS}>{this.state.resultMonth}</p>
                                                    <p style={{float:'left',marginTop: 11.25,marginLeft:10}} > kWh</p>
                                                </Col>
                                                <Col span={10}>
                                                    <p style={{float:'left',marginTop: -5,}}  className={this.state.fontSizeS}>{this.state.carbonResultMonth}</p>
                                                    <p style={{float:'left',marginTop:11,marginLeft:10}}> 吨</p>
                                                </Col>
                                                <Col span={4}>
                                                    <Col className="upButton"> <p style={{float:'left',marginTop:'5%',marginLeft:'25%'}} className="upButtonFont">{this.state.PercentageMonth}</p></Col>
                                                </Col>
                                            </Col>
                                            <Col>
                                                <Col span={15} style={{float:'left',marginTop:-35,}}>
                                                    <p style={{float:'left',}}>上月同期用电：</p>
                                                    <p style={{float:'left',marginLeft:5}} className="kWh" > {this.state.lastMonth}</p>
                                                    <p style={{float:'left',marginLeft:11}}> kWh</p>
                                                    <p> </p>
                                                </Col>
                                                <Col span={10}>
                                        ...
                                        <Col style={{ height: 100 ,marginLeft:10 }}>
                                            ...
                                            <Col span={24}>
                                                <Col span={10}>
                                                    <p style={{float:'left',marginTop: -5,}} className={this.state.fontSizeS}>{this.state.resultyear}</p>
                                                    <p style={{float:'left',marginTop: 11.25,marginLeft:10}} > kWh</p>
                                                </Col>
                                                <Col span={10}>
                                                    <p style={{float:'left',marginTop: -5,}}  className={this.state.fontSizeS}>{this.state.carbonResultyear}</p>
                                                    <p style={{float:'left',marginTop:11,marginLeft:10}}> 吨</p>
                                                </Col>
                                                <Col span={4}>
                                                    <Col className="upButton"> <p style={{float:'left',marginTop:'5%',marginLeft:'25%'}} className="upButtonFont">{this.state.PercentageYear}</p></Col>
                                                </Col>
                                            </Col>
                                            <Col>
                                                <Col span={15} style={{float:'left',marginTop:-35,}}>
                                                    <p style={{float:'left',}}>去年同期用电：</p>
                                                    <p style={{float:'left',marginLeft:5}} className="kWh" > {this.state.lastYear}</p>
                                                    <p style={{float:'left',marginLeft:11}}> kWh</p>
                                                    <p> </p>
                                                </Col>
                                                <Col span={10}>
                    ...
                    <Col span={8}>
                        <Card style={{height: 370 ,marginTop: 10}} bodyStyle={{padding: "0"}}>
                            <div>
                                <Row>

                                    <Col span={ 15} style={{float:'left',marginLeft:10,marginTop: 11 }}>
                                        {/*<p className="madalFont" >负荷曲线</p>*/}
                                        <p className="madalFont" style={{marginLeft:10,marginTop: 0 }}>负荷曲线</p>
                                    </Col>
                                ...
                                <Row>
                                    <Col span={ 24}>
                                        <div span={ 24}  id="loadPro" style={{width:"100%",height:380,marginTop: -50 }}  >  </div>
                                    </Col>
                                </Row>
                            </div>
                        </Card>
                    ...
                    <Col span={8}>
                        ...
                        <Card style={{height: 370 ,marginLeft:10 ,marginTop: 10}} bodyStyle={{padding: "0"}} >
                            <Row>
                                <Col span={ 15} style={{float:'left',marginLeft:10,marginTop: 11 }}>
                                    <p className="madalFont" style={{marginLeft:10,marginTop: 0 }}>分项能耗占比</p>
                                </Col>
                            ...
                            {/*                            <Col>
                             <Col  style={{height: 25 ,marginLeft:41 ,marginRight:41,marginTop: 10}}>
                             暖通用电
                             </Col>
                             <Col  style={{height: 25 ,marginLeft:41 ,marginRight:41,marginTop: 10}}>
                             <Progress
                    ...
                    <Col span={8}>
                        ...
                        <Card style={{height: 370 ,marginLeft:10 ,marginTop: 10}} bodyStyle={{padding: "0"}}    >
                            ...
                            <Col span={8} style={{ marginTop: 10 ,marginLeft:10 ,float:'left'}}>
                                <p className="madalFont" style={{marginLeft:10,marginTop:0 }}>用能管控执行统计</p>
                                {/*<span style={{lineHeight:'24px',float:'left',fontSize:16,}}>*/}
                                {/**/}
                                {/*用能管控执行统计</span>*/}
                            </Col>
                            <Col span={1} style={{marginTop: 13 ,marginLeft:10 ,float:'left'}}>
                                <p  style={{height:'16px',width:'16px'}} className=" classColorBlue" > </p>
                            </Col>
                            <Col span={3} style={{marginTop:10 ,float:'left' ,cursor:"pointer"}} onClick={this.onClickProcessed}>已执行 </Col>
                            <Col  span={3} style={{marginLeft:-15 ,marginTop:10 ,float:'left' ,fontSize:16}} className="greenFont">{this.state.processed}</Col>


                            <Col span={1} style={{marginTop: 13 ,marginLeft:10 ,float:'left'}}>
                                <p  style={{height:'16px',width:'16px'}} className=" classColorRed" > </p>
                            </Col>
                            <Col span={3} style={{marginTop:10 ,float:'left', cursor:"pointer" }} onClick={this.onClickNotProcessed}>未执行</Col>
                            <Col span={3} style={{marginLeft:-15 ,marginTop:10 ,float:'left',fontSize:16}} className="redFont"  >{this.state.notProcessed}</Col>
